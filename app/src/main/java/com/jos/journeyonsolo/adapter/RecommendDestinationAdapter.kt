...
import com.jos.journeyonsolo.databinding.ItemColWisataBinding
import com.jos.journeyonsolo.ui.home.HomeFragmentDirections

class RecommendDestinationAdapter : ListAdapter<ListDestinationItem, RecommendDestinationAdapter.MyViewHolder>(DIFF_CALLBACK) {

    class MyViewHolder(private val binding: ItemColWisataBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = ItemColWisataBinding.inflate(LayoutInflater.from(parent.context), parent, false)
